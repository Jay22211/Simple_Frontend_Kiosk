...
const nonCoffee = [
  {
    ...
    description:
      "A creamy and smooth texture providing a delicious twist to traditional favorites.",
    variations: {
      Tall: 130,
      Grande: 145,
    },
    img: "/images/WhiteChocolate.png",
    alt: "White chocolate drink.",
  },
  {
    id: 11,
    name: "Matcha Latte",
    description:
      "Indulge in the perfect combination of bold coffee and delicate tea flavors.",
    variations: {
      Tall: 130,
      Grande: 145,
    },
  ...
  },
  {
    ...
    description:
      "The blissful taste of this strawberry milk combines the sweetness of strawberries with creamy goodness.",
    variations: {
      Tall: 127,
      Grande: 145,
    },
    img: "/images/StrawberryMilk.png",
    alt: "Strawberry milk drink.",
  },
];
...
const getSelectedPrice = (item, size) => {
  return item.variations?.[size] ?? 0;
};
...
const NonCoffee = () => {
  ...
  const handleAddToOrder = () => {
    addToCart({
      ...
      size: selectedSize,
      price: getSelectedPrice(selectedItem, selectedSize),
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-6">
              ...
              <div className="flex-1">
                  ...
                  <div className="flex justify-center md:justify-start gap-6">
                    {sizeOptions.map((size) => (
                      ...
                      >
                        ...
                        >
                          <AiFillRest
                            className={size === "Tall" ? "text-xl" : "text-3xl"}
                          />
                        </div>
                        <span className="mt-2 text-sm font-medium text-[#4b2e2e]">
                          {size}
                        </span>
                      </div>
                    ))}
                ...
                <div className="bg-[#f5ead1] rounded-xl p-4 mb-6 text-center shadow-sm border border-[#e4d3b6] mx-auto w-130">
                  <p className="text-sm text-[#4b2e2e] font-semibold mb-1">
                    Your Selection:
                  </p>
                  ...
                  <p className="text-xl font-bold text-[#4b2e2e]">
                    ₱{getSelectedPrice(selectedItem, selectedSize)}
                  </p>
                </div>
